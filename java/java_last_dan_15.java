...
class Tmo1{
    ...
    String tmp3;
    int count = 0; 
    public Tmo1(String dfname,int dftscore){
        for(int i=0;i<Max;i++){
            name[i] = dfname;
            kor[i] = dftscore;
            eng[i] = dftscore;
    ...
    public void data3(final Scanner sc){
        ...
        if(dfname.equals("0")){
            ...
            count++;
            System.out.println("기본값으로 이름" + " " + name[count] + " " +"각 점수는 20점으로 기록했습니다.");
            return;
...
public class java_last_dan_15{   
    public static void main(String[] args) {
        final Scanner sc = new Scanner(System.in);
        Tmo1 tmo2 = new Tmo1("슈퍼맨",20);
